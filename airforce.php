                ...
                <li class="block-top-level">
                  ...
                  <div class="isotope-filters isotope-filters-minimal isotope-filters-horizontal" id="isotope-1">
                    <ul class="list-inline">
                      <li><a class="active" id="load" data-isotope-filter="Missile" href="#">Missile</a></li>
                      <li><a data-isotope-filter="Drones" href="#">Drones</a></li>
                      <li><a data-isotope-filter="Air Crafts" href="#">Air Crafts</a></li>
                    </ul>
                  </div>
                </li>
              </ul>
