                ...
                <li class="block-top-level">
                  ...
                  <div class="isotope-filters isotope-filters-minimal isotope-filters-horizontal" id="isotope-1">
                    <ul class="list-inline">
                      <li><a class="active" id="load" data-isotope-filter="Ships" href="#">Ships</a></li>
                      <li><a data-isotope-filter="Aircraft Carrier" href="#">Aircraft Carrier</a></li>
                      <li><a data-isotope-filter="Submarine" href="#">Submarine</a></li>
                    </ul>
                  </div>
                </li>
              </ul>
